...
<head>
    ...
    <title>BACHMESS- Member List</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column" >
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800 text-xl-center">Member List</h1>
                <hr class="divider">

                <!-- DataTales Example -->
                <div class="card shadow mb-4 animated--grow-in">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success">Member List</h6>
                    </div>
                    <div class="card-body">
